...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "",
    appName: "weilailingxian",
    appVersion: "1.0.0",
    appVersionCode: "100",
    appLanguage: getAppLanguage(hostLanguage),
    uniCompileVersion: "4.63",
    uniCompilerVersion: "4.63",
    uniRuntimeVersion: "4.63",
...
function initRuntimeSocketService() {
  const hosts = "192.168.11.1,192.168.220.1,10.6.104.90,127.0.0.1";
  const port = "8091";
  const id = "mp-weixin_zasdp0";
